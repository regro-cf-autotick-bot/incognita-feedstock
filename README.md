...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/incognita-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12173&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/incognita-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `incognita` can be installed with:

```
conda install incognita
```

It is possible to list all of the versions of `incognita` available on your platform with:
